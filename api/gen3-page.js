...
<article class="mode-card mode-card--presenter"><span class="mode-card__badge mode-card__badge--presenter">${presenterBadge}</span><h3>คลิปสร้างตัวตนสาวสวย/หนุ่มหล่อ</h3><p>ออกแบบหน้าตา ลุคประเทศ บุคลิก โทนช่อง และอิริยาบถ ให้ได้พรีเซนเตอร์ที่จำง่ายและสร้างต่อเนื่องได้</p><ul><li>เลือกสวย น่ารัก หล่อเข้ม หล่อละมุน หรือพิมพ์เอง</li><li>เลือกลุคไทย เกาหลี ญี่ปุ่น จีน หรืออินเตอร์</li><li>สร้าง Character Sheet และคลังท่าพร้อมผลิต</li></ul><a class="mode-card__action mode-card__action--presenter" href="/gen3/presenter-identity">เริ่มสร้างตัวตนสายพรีเซนเตอร์ →</a></article>
</div></section>
